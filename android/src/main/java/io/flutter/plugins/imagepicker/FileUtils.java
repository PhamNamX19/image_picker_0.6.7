...
//                    Environment.DIRECTORY_DOWNLOADS), "temp");
            ...
            Log.d("quang", "abc 10 " + extension);
            if (!extension.equals(".jpg"))
                extension = ".jpg";
            file  = File.createTempFile("image_picker", ".jpg", storageDir);
          //  file = new File(imagesFolder, "image_picker" + extension);
        ...
        return success ? file.getPath() : uri.getPath();
    }
